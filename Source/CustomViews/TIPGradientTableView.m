//
//  TIPGradientTableView.m
//  TriviaPlayer
//
//  Created by Nur Monson on 11/9/06.
...
@interface TIPGradientTableView (Private)
- (void)_windowDidChangeKeyNotification:(NSNotification *)notification;
@end

@implementation TIPGradientTableView
...
- (void)highlightSelectionInClipRect:(NSRect)rect;
{
	...
	while (rowIndex != NSNotFound) {
		...
		CGContextSaveGState(context);
			TIPGradientAxialFillRect(context,gradient,(CGRect){{NSMinX(washRect),NSMinY(washRect)}, {NSWidth(washRect),NSHeight(washRect)}},90.0f);
...
@implementation TIPGradientTableView (Private)
